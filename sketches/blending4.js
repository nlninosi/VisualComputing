...
function preload() {
  ...
  colorShader = readShader('/showcase/sketches/shaders/blending2.frag',
...
function setup() {
  ...
  RCB = createCheckbox('RED', false);
  GCB = createCheckbox('GREEN', false);
  BCB = createCheckbox('BLUE', false);
